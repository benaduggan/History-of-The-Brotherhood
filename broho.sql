...
BEGIN;
  ...
  CREATE TABLE enduser(id int primary key, first_name text not null, last_name text not null, email text not null, verified_floor_member smallint, role text not null, password text not null);
